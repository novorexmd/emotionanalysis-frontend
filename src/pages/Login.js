...
import logo from "../assets/images/HasConsulting.jpg";
...
function Login() {
    ...
    const handleSave = () => {
        ...
        localStorage.setItem("token", pas);
        Swal.fire({
            icon: 'success',
        ...
        <Layout>
            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center',width: '400px', height: '200px' }}>
